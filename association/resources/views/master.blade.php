  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      ...
      <a href="#" class="btn-cart dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="d-flex justify-content-center align-items-center"><small>{{session()->has('id')? count($cart_products) : 0}}</small></div>
      </a>
        ...
        <div class="dropdown-item d-flex align-items-start" href="#">
                 ...
                 <div class="text pl-3">
                     ...
                     <p class="mb-0"><a href="#" class="price">{{
                         $product->prod_quantity * $product->prod_price
                       }}</a><span class="quantity ml-3">Quantity: {{$product->prod_quantity}}</span></p>
                 </div>
         </div> 
     @endforeach
        @endif
