...
<div class="container" >
<form style="width: 50%" action="update_manager" method="POST">
    ...
    <div class="mt-3">
      ...
      <input type="password" class="form-control" placeholder="Enter Manager Password ..." name="manager_password" value="{{$manager->manager_password}}">
    </div>
    ...
    <div class="mt-3">
      ...
      <input type="password" class="form-control" placeholder="Enter Confirm Manager Password ..." name="confirm_manager_password" value="{{$manager->manager_password}}">
    </div>
