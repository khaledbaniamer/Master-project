      ...
      <div class="container">
          <div class="row">
              <div class="col-lg-5 mb-5">
                  <img src="{{asset($product->prod_image)}}" class="img-fluid float-end" style="width: 70% ; height:80%"  alt="Colorlib Template">
              </div>
              <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                  <h3>{{$product->prod_name}}</h3>
                  <p class="price" ><span style="color:#b7472a">Product Price :</span><span> {{$product->prod_price}} JOD</span></p>
                  <p><p style="color:#b7472a">Product Description:</p>{{$product->prod_description}}</p>
                  <p><span style="color:#b7472a">Association Name : </span>{{$assoc->assoc_name}}</p> 
                  <p><span style="color:#b7472a">Category Name : </span>{{$category->category_name}}</p> 
                      <div class="row mt-4">
